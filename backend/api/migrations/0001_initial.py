# Generated by Django 5.0.4 on 2024-09-06 02:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_ollama_url', models.CharField(default='http://127.0.0.1', max_length=250)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='liked_by', to='api.message')),
            ],
            options={
