    ...
    <main className="grid flex-1 gap-4 overflow-auto p-4 md:grid-cols-2 lg:grid-cols-5">
      <div className="relative hidden md:flex items-start">
        <div className="w-full space-y-4">
          <fieldset className="grid w-full h-[75vh] rounded-lg border p-4">
          ...
          <div className="h-[12vh] p-4 items-center flex flex-col text-center justify-center rounded-lg border-green-500/50 border-2 bg-green-500/5">
