    ...
    <main className="grid flex-1 gap-4 overflow-auto p-4 md:grid-cols-2 lg:grid-cols-5">
      <div className="relative hidden md:flex items-start">
        <div className="w-full space-y-4">
          <div>
            <Label htmlFor="model">
              <span className="text-primary mr-1">*</span>Model
            </Label>
            {allModels.isLoading ? (
          ...
          <fieldset className="grid w-full h-[66vh] rounded-lg border p-4">
          ...
          <div className="h-[12vh] p-4 items-center flex flex-col text-center justify-center rounded-lg border-primary/50 border-2 bg-primary/5">
            <div className="flex font-semibold text-sm align-middle gap-1 justify-center items-center">
      ...
      <div className="lg:col-span-4">
        <ScrollArea className="relative flex h-full max-h-[75vh] min-h-[50vh] flex-col rounded-xl bg-muted/50 p-4">
          <div className="mx-4">
            {nmessages.length !== 0 &&
