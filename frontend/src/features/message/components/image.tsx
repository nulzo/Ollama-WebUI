...
import { formatBytes } from '@/lib/utils'; // Utility to format bytes to readable format
...
export const Image = ({ src, images = [], currentIndex = 0 }: ImageProps) => {
  ...
  useEffect(() => {
    const handleKeyPress = (event: KeyboardEvent) => {
      ...
      switch (event.key) {
        case 'Escape': setIsModalOpen(false); break;
        case 'ArrowLeft': hasMultipleImages && prevImage(); break;
        case 'ArrowRight': hasMultipleImages && nextImage(); break;
                ...
                <AnimatePresence>
                  {showInfo && imageDetails && (
                    ...
                    >
                      ...
                      <p>{imageDetails.dimensions.width} × {imageDetails.dimensions.height}px</p>
