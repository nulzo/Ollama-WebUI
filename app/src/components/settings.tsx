    ...
    <>
      ...
      <div className="grid gap-4 py-4">
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Input id="name" value="Yeehaw Cowboy" disabled className="col-span-3" />
        </div>
        <div className="grid grid-cols-4 items-center gap-4">
          <Label htmlFor="username" className="text-right">
            Username
          </Label>
          <Input id="username" value="nulzo" disabled className="col-span-3" />
        </div>
      </div>
      <DialogFooter>
    ...
    <>
      ...
      <div className="grid gap-4 py-4">
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Input id="name" value="Default" disabled className="col-span-3" />
        </div>
        <div className="grid grid-cols-4 items-center gap-4">
          <Label htmlFor="username" className="text-right">
            Save History
          </Label>
          <Switch id="airplane-mode" className="col-span-3" />
        </div>
        <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="airplane-mode" className="text-right">Broadcast</Label>
            <Switch id="airplane-mode" className="col-span-3" />
    ...
    <>
      ...
      <div className="grid gap-4 py-4">
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Input id="ip" value="127.0.0.1:11434" disabled className="col-span-3" />
        </div>
        <Separator />
        <div>
            Default Values
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Input id="model" value="Default" disabled className="col-span-3" />
        </div>
      </div>
      <DialogFooter>
        <Button type="submit" disabled>Save changes</Button>
    ...
    <>
      ...
      <div className="grid gap-4 py-4">
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Input id="apikey" disabled value="xxx-xxx-xxx-xxx" className="col-span-3" />
        </div>
        <Separator />
        <div>
            Default Values
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Input id="model" value="model" disabled className="col-span-3" />
        </div>
        <div className="grid grid-cols-4 items-center gap-4">
          <Label htmlFor="temp" className="text-right">
            Temperature
          </Label>
          <Input id="temp" value="1" disabled className="col-span-3" />
        </div>
        <div className="grid grid-cols-4 items-center gap-4">
          <Label htmlFor="topP" className="text-right">
            Top-P
          </Label>
          <Input id="topP" value="0.8" disabled className="col-span-3" />
        </div>
        <div className="grid grid-cols-4 items-center gap-4">
          <Label htmlFor="topK" className="text-right">
            Top-K
          </Label>
          <Input id="topK" value="45" disabled className="col-span-3" />
        </div>
      </div>
      <DialogFooter>
        <Button type="submit" disabled>Save changes</Button>
...
export default function SettingsModal({isOpen, onClose, currentSection}: any) {
  const [section, setSection] = useState<any>(sections[currentSection] ?? sections.profile);
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[700px] grid grid-cols-10">
        <div className="border-r border-border col-span-1">
          <Button
            variant="ghost"
            size="icon"
            onClick={() => {
          ...
          >
            ...
            <span className="sr-only">Ollama</span>
          </Button>
          <Button
            variant="ghost"
            size="icon"
            onClick={() => {
              setSection(sections.openai);
            }}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="col-span-9 mx-8">{section}</div>
      </DialogContent>
    </Dialog>
  );
}
